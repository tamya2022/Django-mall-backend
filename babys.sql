...
INSERT INTO `auth_user` VALUES (8, 'pbkdf2_sha256$390000$cUKU2sraIUgtpxOpK8xqzU$+3PAHVsa6fARsdXOmUTVYV0ThRTM/kfAcPQI8padARo=', '2023-02-22 03:30:47.292841', 1, 'admin', '', '', '', 1, 1, '2020-03-29 12:41:45.739651');
...
INSERT INTO `commodity_commodityinfos` VALUES (4, '婴儿防寒针织帽', '蓝色', '配饰', 50, 39, 2347, 4521, 903, '2020-02-24', 'imgs/p4.jpg', 'details/p4_details.jpg');
INSERT INTO `commodity_commodityinfos` VALUES (5, '婴儿秋冬连体衣冬装衣服', '粉色', '童装', 145, 111, 1341, 3412, 2356, '2020-02-24', 'imgs/p5.jpg', 'details/p5_details.jpg');
...
INSERT INTO `commodity_commodityinfos` VALUES (10, '超薄干爽绿帮纸尿裤', '大码', '纸尿裤', 209, 159, 1234, 4321, 3335, '2020-02-24', 'imgs/p10.jpg', 'details/p10_details.jpg');
...
INSERT INTO `commodity_commodityinfos` VALUES (13, '宝宝芝麻粉辅食调味拌饭', '辅食调味', '宝宝辅食', 59, 39, 1234, 3453, 2321, '2020-02-24', 'imgs/p13.jpg', 'details/p13_details.jpg');
...
INSERT INTO `commodity_commodityinfos` VALUES (17, '80片纯水湿纸巾婴儿', '湿纸巾', '婴儿湿巾', 49.9, 29.9, 1235, 5674, 2317, '2020-02-24', 'imgs/p17.jpg', 'details/p17_details.jpg');
...
CREATE TABLE `shopper_cartinfos`  (
  ...
  `commodityInfos_id_id` int NULL DEFAULT NULL,
  `user_id` int NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `shopper_cartinfos` VALUES (31, 1, 17, 1);
...
-- ----------------------------
INSERT INTO `shopper_orderinfos` VALUES (1, 99.9, '2020-03-29', 1, '已支付');
INSERT INTO `shopper_orderinfos` VALUES (2, 49.9, '2023-02-14', 1, '已支付');
INSERT INTO `shopper_orderinfos` VALUES (3, 49.9, '2023-02-21', 1, '已支付');
